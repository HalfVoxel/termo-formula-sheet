...
Molar isobar värmekapacitet ideal gas\\
$C_p = \frac{1}{\nu} \left ( \frac{\partial U}{\partial T} \right)_p \unit{\joule\per\mol\per\kelvin}$ 
...
$\displaystyle W = -\int_1^2 pdV = \frac{p_1V_1 - p_2V_2}{1-\gamma}$
...
%\subsection{Differentialer}
$\mu$ är en ämneskonstant
